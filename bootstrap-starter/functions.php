...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_script( 'html5hiv',get_template_directory_uri().'/inc/assets/js/html5.min.js', array(), '3.7.0', false );
    ...
    wp_enqueue_script('wp-bootstrap-starter-themejs', get_template_directory_uri() . '/inc/assets/js/theme-script.min.js', array() );
